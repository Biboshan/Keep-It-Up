...
local background2=display.newImageRect("images/sky1.jpg",display.contentWidth,display.contentHeight)
...
physics.addBody(ball1,{bounce=.3,radius=35,friction=1.0})
physics.addBody(ball2,{bounce=.2,radius=35,friction=1.0})
